...
def process_weights_after_loading(
    ...
    # Expert pool (moe_expert_cache_provider=pool): one shared bank for all
    # MoE layers, bound after every layer's tensors are in their final layout.
    ...
    install_expert_pool(
        ...
        max_decode_tokens=(
            ...
            if get_current_vllm_config().scheduler_config is not None
            else 1
        ),
    )
